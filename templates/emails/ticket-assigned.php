<?php
/**
 * Email Template: Ticket Assignment Notification
 */
...
<h2><?php _e('Ticket Assigned to You', 'altalayi-ticket'); ?></h2>

<p><?php printf(__('Hello %s,', 'altalayi-ticket'), esc_html($assigned_user->display_name)); ?></p>

<p><?php _e('A tire complaint ticket has been assigned to you. Please review the details and take appropriate action.', 'altalayi-ticket'); ?></p>
...
<div class="ticket-info">
    ...
    <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
            <td style="padding: 10px; border-bottom: 1px solid #eee; font-weight: bold;">
                <?php _e('Created:', 'altalayi-ticket'); ?>
            </td>
            <td style="padding: 10px; border-bottom: 1px solid #eee;">
...
<div style="background: #d4edda; border: 1px solid #c3e6cb; padding: 20px; border-radius: 8px; margin: 20px 0;">
    <h3 style="margin-top: 0; color: #155724;"><?php _e('What to do next?', 'altalayi-ticket'); ?></h3>
    <ul style="margin-bottom: 0; color: #155724;">
        <li><?php _e('Review the customer complaint and tire details', 'altalayi-ticket'); ?></li>
        <li><?php _e('Contact the customer if additional information is needed', 'altalayi-ticket'); ?></li>
        <li><?php _e('Update the ticket status as you progress', 'altalayi-ticket'); ?></li>
        <li><?php _e('Add notes to document your investigation and actions taken', 'altalayi-ticket'); ?></li>
    </ul>
</div>

<p><?php _e('Thank you for your attention to this matter.', 'altalayi-ticket'); ?></p>
